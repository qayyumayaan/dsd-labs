module fft16 (
    ...
    logic signed [31:0] real_stage[4:0][15:0];
    logic signed [31:0] imag_stage[4:0][15:0];
...
always_comb begin
    ...
    for (stage = 1; stage <= 4; stage++) begin
        int step;          // Declare the variable first
        int half_step;     // Declare the variable first
        step = 1 << stage; // Assign value separately
        half_step = step >> 1; // Assign value separately
